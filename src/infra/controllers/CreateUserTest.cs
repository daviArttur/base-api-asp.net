...
namespace Testes.src.infra.controllers
{
    ...
    {
        private CreateUserController _controler;
        private Mock<ICreateUserUseCase> _useCaseMock;

        [SetUp] 
        public void SetUp()
        {
            this._useCaseMock = new Mock<ICreateUserUseCase>();
            this._controler = new CreateUserController(_useCaseMock.Object);
        }
        ...
        public async Task ItShouldCallUseCaseWithCorrectParams()
        {
            ...
            // Arrange
            this._useCaseMock.Setup(todo => todo.Perform(createUserDtoInfra.Email, createUserDtoInfra.Password));
            // Act
